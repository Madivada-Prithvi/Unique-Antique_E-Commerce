...
import { ArrowRight, Star, Crown, Shield, Truck, Award, Sparkles, Diamond, Users, Globe } from 'lucide-react';
    ...
    <div className="min-h-screen">
      ...
      >
        ...
        >
          ...
          >
            Where <span className="text-gold-400 font-medium">luxury</span> meets <span className="text-gold-400 font-medium">legacy</span>, 
            and every piece tells a story of <span className="text-gold-400 font-medium">timeless elegance</span>
          </motion.p>
          ...
          >
            <Link to="/shop">
              <Button size="lg" className="group bg-gradient-to-r from-gold-500 to-gold-600 hover:from-gold-600 hover:to-gold-700 text-white px-8 py-4 text-lg">
            ...
            <Link to="/collections">
              <Button variant="outline" size="lg" className="text-white border-2 border-white hover:bg-white hover:text-navy-900 px-8 py-4 text-lg">
      ...
      <ParallaxSection speed={0.3}>
        <section ref={statsRef} className="py-20 bg-gradient-to-r from-navy-900 to-navy-800 dark:from-black dark:to-gray-900">
      ...
      <ParallaxSection speed={0.2}>
        <section ref={featuresRef} className="py-24 bg-marble-50 dark:bg-gray-900 relative overflow-hidden">
          {/* Background Pattern */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 text-xl max-w-3xl mx-auto leading-relaxed">
                We redefine luxury through exceptional quality, unparalleled service, and an unwavering commitment to excellence.
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  description: 'Every item comes with certificate of authenticity and comprehensive quality assurance.',
                  color: 'from-blue-500 to-blue-600',
                },
                {
                  icon: Truck,
                  title: 'White-Glove Delivery',
                  description: 'Premium shipping service with insurance, tracking, and personalized handling.',
                  color: 'from-green-500 to-green-600',
                },
                {
                  icon: Award,
                  title: 'Curated Excellence',
                  description: 'Hand-picked luxury items from renowned artisans and prestigious brands worldwide.',
                  color: 'from-purple-500 to-purple-600',
                },
                {
                  icon: Star,
                  title: 'Concierge Support',
                  description: '24/7 dedicated service from our luxury specialists and personal consultants.',
      ...
      <ParallaxSection speed={0.1}>
        <section ref={productsRef} className="py-24 bg-white dark:bg-black relative">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              initial={{ opacity: 0, y: 30 }}
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 text-xl max-w-3xl mx-auto leading-relaxed">
                Discover our most coveted pieces, each carefully selected for the discerning collector who appreciates true artistry.
              </p>
            </motion.div>
            ...
            >
              <Link to="/shop">
                <Button size="lg" variant="outline" className="group border-2 border-gold-500 text-gold-600 hover:bg-gold-500 hover:text-white px-8 py-4">
                  <Diamond className="mr-3 h-6 w-6" />
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <motion.div
          ...
          style={{
            backgroundImage: 'linear-gradient(45deg, transparent 30%, rgba(255, 215, 0, 0.1) 50%, transparent 70%)',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            ...
            <p className="text-gray-300 text-xl mb-12 max-w-3xl mx-auto leading-relaxed">
              Be the first to discover exclusive collections, rare finds, and receive personalized recommendations from our luxury experts.
            </p>
